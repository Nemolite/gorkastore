		...
		<div id="review_form_wrapper">
			<div id="review_form">
				...
				$comment_form = array(
					...
					'comment_notes_after' => '',
					'fields'              => array(
						'author' => '<div class="row"><p class="comment-form-author col s12 m6"><label for="author">' . esc_html__( 'Name', 'woocommerce' ) . '&nbsp;<span class="required">*</span></label> ' .
									'<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" required /></p>',
						'email'  => '<p class="comment-form-email col s12 m6"><label for="email">' . esc_html__( 'Email', 'woocommerce' ) . '&nbsp;<span class="required">*</span></label> ' .
